...
| Поле | Обяз. | Значение |
|---|---|---|
| `alias` | да | Ключ для YAML (`runner: 'baseline'`), уникален, `^[a-z0-9][a-z0-9_.-]{1,30}$` |
...
| Поле | Обяз. | Значение |
|---|---|---|
| `alias` | да | Ключ для `runners[].database`, уникален, та же форма `^[a-z0-9][a-z0-9_.-]{1,30}$`, что и у алиаса раннера |
